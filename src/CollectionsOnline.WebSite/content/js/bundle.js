...
},{"./images":2,"./search":3,"jquery":6}],2:[function(require,module,exports){
var $ = require('jquery');
...
},{"jquery":6,"jquery-autocompleter":4,"query-string":5}],4:[function(require,module,exports){
/*
...
(function () {
  ...
  queryString.parse = function (str) {
    ...
    return str.trim().split('&').reduce(function (ret, param) {
      ...
      val = val === undefined ? null : decodeURIComponent(val.replace(/\+/g, '%20'));
    ...
    return obj ? Object.keys(obj).map(function (key) {
      ...
      if (Array.isArray(val)) {
        return val.map(function (val2) {
          return encodeURIComponent(key).replace(/%20/g, '+') + '=' + encodeURIComponent(val2).replace(/%20/g, '+');
        }).join('&');
      }

      return encodeURIComponent(key).replace(/%20/g, '+') + '=' + encodeURIComponent(val).replace(/%20/g, '+');
    }).join('&') : '';
  };
