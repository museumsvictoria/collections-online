...
module.exports = {
  ...
  cacheElements: function () {
    ...
    this.$videoLoaded = $([
    '<div class="video loaded" style="background-image: url(' + this.Video.Small.Uri + ');width:' + this.Video.Small.Width + 'px;">',
  ...
  select: function (e) {
    if (this.Video !== undefined) {
      this.$videoLoaded.replaceWith('<iframe height="' + this.Video.Small.Height + '" width="' + this.Video.Small.Width + '" title="' + this.Video.AlternativeText + '" src="http://www.youtube.com/embed/' + this.Video.VideoId + '?cc_load_policy=1&disablekb=0&autoplay=1"></iframe>');
    }
  }
};