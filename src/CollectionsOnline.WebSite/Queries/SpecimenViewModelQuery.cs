            ...
            using (_documentSession.Advanced.DocumentStore.AggressivelyCacheFor(Constants.AggressiveCacheTimeSpan))
            {
                ...
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.Ocean))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Ocean",
                        string.Format(@"<a href=""/search?locality={0}"">{1}</a>",
                            HttpUtility.UrlEncode(result.Specimen.CollectionSite.Ocean), result.Specimen.CollectionSite.Ocean)));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.Continent))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Continent",
                        string.Format(@"<a href=""/search?locality={0}"">{1}</a>",
                            HttpUtility.UrlEncode(result.Specimen.CollectionSite.Continent), result.Specimen.CollectionSite.Continent)));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.Country))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Country",
                        string.Format(@"<a href=""/search?locality={0}"">{1}</a>",
                            HttpUtility.UrlEncode(result.Specimen.CollectionSite.Country), result.Specimen.CollectionSite.Country)));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.State))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("State",
                        string.Format(@"<a href=""/search?locality={0}"">{1}</a>",
                            HttpUtility.UrlEncode(result.Specimen.CollectionSite.State), result.Specimen.CollectionSite.State)));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.District))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("District",
                        string.Format(@"<a href=""/search?locality={0}"">{1}</a>",
                            HttpUtility.UrlEncode(result.Specimen.CollectionSite.District), result.Specimen.CollectionSite.District)));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.Town))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Town",
                        string.Format(@"<a href=""/search?locality={0}"">{1}</a>",
                            HttpUtility.UrlEncode(result.Specimen.CollectionSite.Town), result.Specimen.CollectionSite.Town)));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.NearestNamedPlace))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Nearest Named Place",
                        string.Format(@"<a href=""/search?locality={0}"">{1}</a>",
                            HttpUtility.UrlEncode(result.Specimen.CollectionSite.NearestNamedPlace), result.Specimen.CollectionSite.NearestNamedPlace)));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.PreciseLocation))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Precise Location",
                        result.Specimen.CollectionSite.PreciseLocation));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.MinimumElevation))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Minimum Elevation",
                        result.Specimen.CollectionSite.MinimumElevation));
                ...
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.GeodeticDatum))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Geodetic Datum",
                        result.Specimen.CollectionSite.GeodeticDatum));
                ...
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.GeoreferenceSource))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Georeference Source",
                        result.Specimen.CollectionSite.GeoreferenceSource));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.GeoreferenceProtocol))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Georeference Protocol",
                        result.Specimen.CollectionSite.GeoreferenceProtocol));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.GeoreferenceDate))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Georeference Date",
                        result.Specimen.CollectionSite.GeoreferenceDate));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.GeoreferenceBy))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Georeference By",
                        result.Specimen.CollectionSite.GeoreferenceBy));
                ...
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.GeologyGroup))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Geological group",
                        result.Specimen.CollectionSite.GeologyGroup));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.GeologyFormation))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Geological formation",
                        result.Specimen.CollectionSite.GeologyFormation));
                if (!string.IsNullOrWhiteSpace(result.Specimen.CollectionSite.GeologyMember))
                    result.GeoSpatial.Add(new KeyValuePair<string, string>("Geological member",
                        result.Specimen.CollectionSite.GeologyMember));
